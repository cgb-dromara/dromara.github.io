...
export const zhMembersOption: MembersOption = {
  ...
  FOUNDER: {
    ...
    desc: "Apache ShenYu 创始人/VP，Apache Member，Hmliy，Raincat，Myth 等分布式事务框架作者， 腾讯云TVP. 著有《深入理解分布式事务：原理与实战》一书。曾获评 开源先锋 33 之一, 信通院 OSCAR 尖峰开源人物等奖项。"
  },
  MEMBERS_ITEM: [
    {
      header: "秘书处",
      ...
      members: [
        {
          role: "TOC成员",
          name: "陈斌",
          photo: "/assets/img/members/chenbin.webp",
          desc: "一个普通的搬砖人"
        },
        {
          role: "TOC成员",
          name: "张永伦",
          photo: "/assets/img/members/zhangyonglun.webp",
          desc: ""
        },
        {
          role: "TOC成员",
          name: "秋尔",
          photo: "/assets/img/members/qiuer.webp",
          desc: "Jpom 作者"
        },
        {
          role: "TOC成员",
          name: "铂赛东",
          photo: "/assets/img/members/bryan31.webp",
          desc: "开源项目LiteFlow作者，开源项目TLog作者，拥有2个GVP荣誉，[元人部落]公众号博主。基础中间件架构师，深耕架构相关工作十多年。一个永远勇敢坚定追逐光的即将不惑之年的开发者。立志把LiteFlow带入中国顶尖开源软件的行列。"
        },
        {
          role: "TOC成员",
          name: "公子骏",
          photo: "/assets/img/members/gongzijun.webp",
          desc: "开源项目 Forest 作者，Java 后台架构师。有十多年 Java 开发经验，主要专注于架构、微服务、分布式等领域，也会研究机器学习、算法等业界新技术。"
        },
        {
          role: "TOC成员",
          name: "路小磊",
          photo: "/assets/img/members/looly.webp",
          desc: "Hutool 作者"
        },
        {
          role: "TOC成员",
          name: "刘潇",
          photo: "/assets/img/members/liuxiao.webp",
          desc: "Sa-Token 作者"
        },
        {
          role: "TOC成员",
    ...
    },
    {
      ...
      members: [
        ...
        },
        {
          ...
          desc: "RuoYi-Vue-Plus/RuoYi-Cloud-Plus 作者"
        },
        {
          role: "委员会成员",
          name: "雨韵诗泽 / 傲世孤尘",
          photo: "/assets/img/members/aoshiguchen.webp",
          desc: "Neutrino-Proxy 作者"
        },
        {
          role: "委员会成员",
          name: "风如歌",
    ...
    },
    {
      ...
      members: [
        ...
        },
        {
          ...
          desc: "HertzBeat Committer，主要贡献有 Zookeeper协议兼容、JVM协议兼容、tomcat服务器监控、MQ监控、适配ElasticSearch中间件监控等"
        },
        {
          role: "成员",
          name: "小眼",
        ...
        },
        {
          ...
          desc: "Liteflow Committer，主要贡献有liteflow-sql插件开发等"
        },
        {
          role: "成员",
          name: "DaleLee",
          photo: "/assets/img/members/DaleLee.webp",
          desc: "Liteflow Committer，主要贡献有对任意组件进行超时控制等"
        },
        {
          role: "成员",
          name: "KamToHung",
        ...
        },
        {
          ...
          desc: "Liteflow Committer，主要贡献有循环异步模式等"
        },
        {
          role: "成员",
          name: "Rainie",
