...
export const zhProjectsOption: ProjectsOption = {
  ...
  HMILY_DESC: "柔性分布式事务解决方案",
  RAINCAT_DESC: "强一致性分布式事务解决方案",
  MYTH_DESC: "可靠消息分布式事务解决方案",

  POPULAR_TOOLS: "流行工具",
  HUTOOL_DESC: "小而全的Java工具类库",
  FOREST_DESC: "更轻量，更简单实用的HTTP客户端框架",
  LITEFLOW_DESC: "轻量，快速，稳定，可编排的组件式流程引擎",
  DYNAMIC_TP_DESC: "基于配置中心的轻量级动态线程池，内置监控告警功能",
  EASY_ES_DESC: "更易用的ES搜索引擎框架",
  GO_VIEW_DESC: "高效的低代码「数据可视化」开发平台",
  ...
  DYJAVA:
    "DyJava是一款功能强大的抖音Java开发工具包（SDK），支持抖音各个应用OpenAPI快速调用，包括但不限于移动/网站应用、抖音开放平台、抖店和抖音小程序等",
  ORION_VISOR: "一款高颜值、现代化的智能运维&轻量堡垒机平台。",
  WARM_FLOW:
    "国产工作流引擎,其特点简洁轻量但又不简单，五脏俱全，组件独立，可扩展，可满足中小项目的组件.解决flowable和activities复杂、学习成本高和集成难等痛点。",
  DBSWITCH: "异构数据库迁移同步(搬家)工具",
  SKYEYE_OA: "智能制造一体化，采用Springboot + winUI的低代码平台开发模式",
  EASYAI:
    "国内人气最高的Java人工智能算法框架(java版pytorch)。它可以Maven一键丝滑引入我们的Java项目，无需任何额外的环境配置与依赖，做到开箱即用",
  MYBATIS_PLUS_EXT:
    "mybatis-plus框架的拓展包，在框架原有基础上做了进一步的轻度封装",
  ...
  AKALI:
    "Akali(阿卡丽)，轻量级本地化热点检测/降级框架，10秒钟即可接入使用！大流量下的神器",
  ...
  MAXKEY_DESC: "业界领先的企业级开源IAM身份管理和身份认证产品",
  SURENESS_DESC: "面向REST API的高性能认证鉴权框架",
  ...
  DISTRIBUTED_LOG: "分布式日志",
  TLOG_DESC: "轻量级的分布式日志标记追踪神器",
  ...
  MICROSERVICE: "微服务",
  KOALAS_RPC_DESC: "高可用可拓展的RPC框架",
  MENDMIX_DESC: "一站式分布式云原生架构技术底座",
...
export default zhProjectsOption;
