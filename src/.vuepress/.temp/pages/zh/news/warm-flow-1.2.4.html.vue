<template><div><h2 id="warm-flow-1-2-4版本更新" tabindex="-1"><a class="header-anchor" href="#warm-flow-1-2-4版本更新"><span>warm-flow 1.2.4版本更新</span></a></h2>
<ul>
<li>
...
<blockquote>
<p>Warm-Flow国产工作流引擎🎉，其特点简洁轻量但又不简单，五脏俱全，组件独立，可扩展，可满足中小项目的组件。</p>
</blockquote>
<ol>
<li>
