...
<h2 id="warm-flow-1-2-6版本更新" tabindex="-1"><a class="header-anchor" href="#warm-flow-1-2-6版本更新"><span>warm-flow 1.2.6版本更新</span></a></h2>
<h3 id="本次改动" tabindex="-1"><a class="header-anchor" href="#本次改动"><span>本次改动</span></a></h3>
<blockquote>
<p>流程状态：可接收外部传递，可以支持字符串<br>
新增api：增加获取下个节点信息<br>
id生成：支持其他位数的id，可以前端精度问题的序列化处理</p>
</blockquote>
<ul>
<li>
...
<li>
<p>[feat] 增加获取下个节点集合api  @xiarigang</p>
</li>
<li>
<p>[feat] id内存策略新增14、15位雪花算法支持</p>
</li>
<li>
<p>[feat] 流程激活和挂起案例  @xiaoxiaoliu889</p>
</li>
<li>
<p>[feat] 增加基于流程定义Id获取流程图  @xiaoxiaoliu889</p>
</li>
<li>
<p>[update] 流程状态改成字符串类型  @xiarigang</p>
</li>
<li>
<p>[update] 测试模块拆分独立仓库</p>
</li>
<li>
<p>[update] modes-sb删除加载配置文件，改为有上层jar加载</p>
</li>
<li>
<p>[update] flex solon版本yml弄错了，config调整</p>
</li>
<li>
<p>[refactor] 流程版本号生成逻辑重构  @xiaoxiaoliu889</p>
</li>
<li>
<p>[fix] 修复deleteByTaskIds 中的根据无法正确删除user数据</p>
</li>
<li>
<p>[fix] 修复 jpa solon注解问题  @vanlin</p>
</li>
<li>
<p>[fix] 修复 并行网关三个任务分支的时候，错误结束流程的问题</p>
</li>
<li>
<p>执行升级脚本【warm-flow_1.2.6.sql】</p>
</li>
<li>
<p>流程状态字段flow_status改为string类型，业务系统需要对应修改</p>
</li>
<li>
<p>【升级注意事项】</p>
</li>
...
<h2 id="warm-flow介绍" tabindex="-1"><a class="header-anchor" href="#warm-flow介绍"><span>warm-flow介绍</span></a></h2>
<blockquote>
...
<li>
<p>条件表达式：内置常见的条件表达式，并且支持自定义扩展</p>
</li>
<li>
