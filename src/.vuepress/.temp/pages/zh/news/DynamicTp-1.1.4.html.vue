...
<h2 id="v1-1-4-发版记录" tabindex="-1"><a class="header-anchor" href="#v1-1-4-发版记录"><span>v1.1.4 发版记录</span></a></h2>
<ul>
<li>
...
<li>
<p>第三方线程池（tomcat、undertow、dubbo、rocketmq、okhttp3 等等）支持 run_timeout、queue_timeout、reject 告警，@kyao，@yanhom
<img src="/assets/img/news/DynamicTp-1.1.4-1.png" alt=""></p>
</li>
<li>
...
<ul>
<li>修复 Tomcat 高低版本兼容性报错问题，@yanhom</li>
<li>修复其他 agent 增强线程池后，强转 DtpRunnable 失败的问题，@yanhom</li>
<li>修复企微告警无@提醒的问题，@yanhom</li>
<li>修复企微告警配置多个接受人不能正确@的问题，@KamToHung</li>
<li>修复钉钉告警不能@所有人问题，@chenan</li>
<li>修复因 Bean 初始化顺序不确定导致的 ApplicationContextHolder npe 问题，@yanhom</li>
<li>修复修复拒绝策略为 CallerRunsPolicy 时，MdcRunnable 会删除主线程 mdc 信息的问题，@kyao</li>
</ul>
<h4 id="optimize" tabindex="-1"><a class="header-anchor" href="#optimize"><span>Optimize</span></a></h4>
<ul>
<li>优化 dtp 内部 spi 的使用，统一封装管理，@peachyy</li>
<li>部分代码优化重构，@yanhom，@KamToHung，@dragon-zhang，@kyao</li>
<li>告警信息优化，trace 信息可以自己扩展，集成内部 ELK 等平台，@yanhom</li>
</ul>
<figure><img src="/assets/img/news/DynamicTp-1.1.4-2.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<p>新增分群 4，可以自行扫码加入，或者加我微信拉入其他群！</p>
<img src="/assets/img/news/DynamicTp-1.1.4-3.jpg" height="340">
<br>
<img src="/assets/img/news/DynamicTp-1.1.4-4.png" height="340">
<p>https://dynamictp.cn</p>
<p>https://gitee.com/dromara/dynamic-tp</p>
<p>https://github.com/dromara/dynamic-tp</p>
</div></template>
