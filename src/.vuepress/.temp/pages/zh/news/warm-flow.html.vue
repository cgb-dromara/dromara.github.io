<template><div><h3 id="作者介绍" tabindex="-1"><a class="header-anchor" href="#作者介绍"><span>作者介绍</span></a></h3>
<ul>
<li>
<p>名称：warm</p>
</li>
<li>
<p>dromara 开源组织成员，dromara/warm-flow作者</p>
</li>
<li>
<p>研发工程师、技术经理，工作经验8年。此工作流已经持续开发有一年有余。</p>
</li>
<li>
...
<blockquote>
<p><strong>那何不开发属于国人的工作流呢，为此耗时一年时间自研warm-flow工作流。</strong></p>
</blockquote>
<h3 id="warm-flow能给你带来什么" tabindex="-1"><a class="header-anchor" href="#warm-flow能给你带来什么"><span>warm-flow能给你带来什么</span></a></h3>
<p>国产自研工作流，其特点简洁(只有6张表)但又不简单，五脏俱全，组件独立，可扩展，可满足中小项目的组件。</p>
<ol>
<li>
<p>支持常规的流程流转，比如跳转、回退、审批和任意跳转</p>
</li>
<li>
<p>支持转办、终止，任务最终回到发起人</p>
</li>
<li>
<p>支持或签（会签和票签开发中）</p>
</li>
<li>
<p>业务项目可不依赖流程设计器，组件可生成流程图片</p>
</li>
<li>
<p>支持角色、部门和用户等权限配置</p>
</li>
...
<li>
<p>兼容java8、java17及以上版本，理论11也可以</p>
</li>
<li>
<p>官方提供简单流程封装demo项目，很实用</p>
</li>
</ol>
<blockquote>
<p>接<strong>入warm-flow后妈妈再也不用担心我加班了</strong></p>
</blockquote>
<h3 id="项目功能模块" tabindex="-1"><a class="header-anchor" href="#项目功能模块"><span>项目功能模块</span></a></h3>
...
<figure><img src="/assets/img/news/warm-flow-0.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<figure><img src="/assets/img/news/warm-flow-1.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<h4 id="监听器管理" tabindex="-1"><a class="header-anchor" href="#监听器管理"><span>监听器管理</span></a></h4>
...
<ul>
<li>
<p>create：创建监听器，任务创建时执行</p>
</li>
<li>
<p>start：开始监听器，任务开始办理时执行</p>
</li>
<li>
<p>permission：权限监听器，办理任务动态设置权限</p>
</li>
<li>
<p>assignment：分派办理人监听器，分派后执行</p>
</li>
<li>
<p>finish：结束监听器，当前任务完成后执行</p>
</li>
</ul>
<ol start="3">
<li>监听器生命周期</li>
</ol>
<figure><img src="/assets/img/news/warm-flow-2.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p>输入图片说明</p>
<h4 id="配置管理" tabindex="-1"><a class="header-anchor" href="#配置管理"><span>配置管理</span></a></h4>
<p>配置文件可以让工作流使用更加方便，如虎添翼。</p>
<ol>
<li>
<p>配置文件目前支持banner图和填充器配置，后续还会增加多租户和软删除等。</p>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="扩展支持" tabindex="-1"><a class="header-anchor" href="#扩展支持"><span>扩展支持</span></a></h3>
<h4 id="orm和数据库扩展" tabindex="-1"><a class="header-anchor" href="#orm和数据库扩展"><span>orm和数据库扩展</span></a></h4>
<p>作为新时代的程序员不能固步自封，只支持mybatis和msyql。所以目前已经解偶数据库操作，按照mybatis方式扩展其他的orm或者数据库类型即可</p>
<figure><img src="/assets/img/news/warm-flow-3.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p>输入图片说明</p>
<h4 id="条件表达式扩展" tabindex="-1"><a class="header-anchor" href="#条件表达式扩展"><span>条件表达式扩展</span></a></h4>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="联系作者" tabindex="-1"><a class="header-anchor" href="#联系作者"><span>联系作者</span></a></h3>
