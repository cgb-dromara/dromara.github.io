<template><div><h2 id="作者介绍" tabindex="-1"><a class="header-anchor" href="#作者介绍"><span>作者介绍</span></a></h2>
<ul>
<li>
<p>名称:xuejm</p>
</li>
...
<p>ORM又叫对象关系映射,一款好的ORM不仅仅是支持OM更重要的是把<code v-pre>R</code>合理的利用起来<code v-pre>easy-query</code>就是一款支持对象关系和SQL表达式的现代化ORM.</p>
<h2 id="easyquery介绍" tabindex="-1"><a class="header-anchor" href="#easyquery介绍"><span>EasyQuery介绍</span></a></h2>
<p>EasyQuery是一款Java下面的现代化ORM,拥有强类型、轻量级、高性能特点,致力于解决jdbc查询,支持对象模型关系筛选,隐式查询,纯SQL表达式查询。</p>
<p>框架支持java8及以上版本完全无依赖干净,支持分库分表、字段加密、联级筛选、逻辑删除、多租户、动态表名、无实体CRUD、计算属性、乐观锁、批处理、数据追踪差异更新等一系列功能,并且给予用户极大地扩展和方言自定义功能扩展。</p>
<figure><img src="/assets/img/news/EasyQuery-0.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<h3 id="背景" tabindex="-1"><a class="header-anchor" href="#背景"><span>背景</span></a></h3>
<p><strong>使用现有orm中你是否有以下痛点呢?</strong></p>
<blockquote>
<p>1.orm使用都是字符串不易维护,ide无法智能提示</p>
<p>2.orm不支持join或者多表join功能偏弱无法满足group+join 子查询或者from 子查询等情况</p>
<p>3.orm模型联级筛选对象关系过弱,仅支持一对多一对一等的拉取,不支持筛选过滤</p>
<p>4.没有统一的函数来支持映射翻译到所有的数据库</p>
<p>5.orm功能薄弱想支撑业务需要添加各种外部组件来满足业务</p>
<p>6.orm无法和现有pojo体系完美融合兼容</p>
<p>7.不支持分库分表需要额外引入sharding来支持</p>
</blockquote>
<p>如果你有以上痛点,那么<code v-pre>easy-query</code>获取能够帮助到你。</p>
<p><strong>使用easy-query可以为开发者带来什么?</strong></p>
<blockquote>
<p>1.简单易用高效的api,流式书写带来的便捷性和易维护性,拒绝魔法值</p>
<p>2.强类型只能提示哪怕你是刚入门小白也能在idea的提示下很容易写出想要的代码</p>
<p>3.复杂多表join,子查询,exists面对各种复杂业务场景再也不用担心需要额外引入组件了</p>
<p>4.模型关系查询将ORM的<code v-pre>R</code>体现的淋漓尽致,不仅仅是简单的查询出结果更能完美的进行对象模型筛选,犹如stream查询数据库一样可以以<code v-pre>any</code>,<code v-pre>none</code>等方法断言和我相关的数据</p>
<p>5.结构化DTO任意拉取,可以在用户创建各个模型关系后快速拉去任意结构的对象转成json,不用再烦恼一对一、多对一、一对多、多对多在分页下的获取了</p>
<p>6.完美杜绝n+1带来的性能问题</p>
<p>7.所有功能完全免费永久开源,并且作者自行编写idea插件帮助大家提高效率happy code</p>
</blockquote>
<h2 id="实际业务案例" tabindex="-1"><a class="header-anchor" href="#实际业务案例"><span>实际业务案例</span></a></h2>
<p>系统的用户架构一般是用户角色（多对多），用户企业多对1，角色菜单多对多</p>
<h3 id="用户筛选" tabindex="-1"><a class="header-anchor" href="#用户筛选"><span>用户筛选</span></a></h3>
<h4 id="简单筛选" tabindex="-1"><a class="header-anchor" href="#简单筛选"><span>简单筛选</span></a></h4>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="隐式筛选" tabindex="-1"><a class="header-anchor" href="#隐式筛选"><span>隐式筛选</span></a></h4>
<h5 id="一对一隐式join" tabindex="-1"><a class="header-anchor" href="#一对一隐式join"><span>一对一隐式join</span></a></h5>
<blockquote>
<p>因为用户和企业是多对一的关系所以可以在筛选用户的时候利用对象关系以企业为条件进行筛选从而自动进行join</p>
</blockquote>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="一对多隐式子查询" tabindex="-1"><a class="header-anchor" href="#一对多隐式子查询"><span>一对多隐式子查询</span></a></h5>
<blockquote>
<p>当我们在用户对象里面创建好企业关系可以在筛选用户时使用企业作为条件,反之我们在企业模型里面创建好企业和用户的关系我们在筛选企业的时候一样可以使用用户作为条件帮我们快速实现筛选</p>
</blockquote>
...
<span class="line"><span>    }).toList();</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="多表显式join" tabindex="-1"><a class="header-anchor" href="#多表显式join"><span>多表显式join</span></a></h5>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="直接获取用户拥有的菜单" tabindex="-1"><a class="header-anchor" href="#直接获取用户拥有的菜单"><span>直接获取用户拥有的菜单</span></a></h5>
<blockquote>
<p>用户和菜单并没有直接关系中间和角色表是多对多中间还有两张表user_role和role_menu表</p>
</blockquote>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="返回用户结构附带角色" tabindex="-1"><a class="header-anchor" href="#返回用户结构附带角色"><span>返回用户结构附带角色</span></a></h5>
<blockquote>
<p>返回结果</p>
</blockquote>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="隐式查询获取匿名结果" tabindex="-1"><a class="header-anchor" href="#隐式查询获取匿名结果"><span>隐式查询获取匿名结果</span></a></h5>
<blockquote>
<p>有时候我们需要在上文获取中间结果便于java内部计算,大部分orm在这个时候只支持返回map对象,这样会导致在使用时会遍布字符串并且具体类型也会丢失导致使用起来非常不方便</p>
</blockquote>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span></span></span>
...
<span class="line"><span>      )).toList();</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="结构化dto" tabindex="-1"><a class="header-anchor" href="#结构化dto"><span>结构化DTO</span></a></h3>
<p>很多时候我们在访问响应时需要返回自定义的数据结构,而不是整个数据库结构</p>
<p>所以我们这边使用easy-query插件来快速实现构建结构化DTO响应</p>
<ul>
<li>
<p>首先我们在idea插件市场安装<code v-pre>EasyQueryAssistant</code>插件最新版本</p>
</li>
<li>
<p>第二部在需要创建DTO的包右键CreateStructDTO</p>
</li>
<li>
<p>第三步选择需要返回的结构化数据</p>
<figure><img src="/assets/img/news/EasyQuery-1.jfif" alt="" tabindex="0"><figcaption></figcaption></figure>
<figure><img src="/assets/img/news/EasyQuery-2.jfif" alt="" tabindex="0"><figcaption></figcaption></figure>
</li>
</ul>
<blockquote>
<p>最终会生成如下dto</p>
...
<span class="line"><span>    .toList();</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="函数翻译" tabindex="-1"><a class="header-anchor" href="#函数翻译"><span>函数翻译</span></a></h3>
<h4 id="通用函数" tabindex="-1"><a class="header-anchor" href="#通用函数"><span>通用函数</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<h4 id="字符串函数" tabindex="-1"><a class="header-anchor" href="#字符串函数"><span>字符串函数</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<tr>
<td>join</td>
<td>字符串多列join组合返回常用语group+逗号组合</td>
</tr>
<tr>
<td>length</td>
<td>字符串长度</td>
...
<h4 id="时间函数" tabindex="-1"><a class="header-anchor" href="#时间函数"><span>时间函数</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<tr>
<td>duration</td>
<td>返回间隔天/小时/....  a.duration(b,DateTimeDurationEnum.Days) a比b大多少天,如果a小于b则返回负数 两个日期a,b之间相隔多少天</td>
</tr>
<tr>
<td>now</td>
<td>当前时间</td>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果您对此框架有兴趣那么欢迎您的尝试，也欢迎您的意见建议,框架拥有太多的功能无法在这里意义展示,更多的功能可以访问 github仓库 或gitee仓库 进行查阅</p>
<h3 id="最后" tabindex="-1"><a class="header-anchor" href="#最后"><span>最后</span></a></h3>
<p><code v-pre>easy-qeury</code>很高兴加入dromara这个组织希望可以再组织下茁壮成长,为java开源贡献一份自己的微弱力量</p>
<p>最后附上项目地址欢迎大家加入star提交pr issue</p>
<p>github仓库 https://github.com/dromara/easy-query</p>
<p>gitee仓库 https://gitee.com/dromara/easy-query</p>
</div></template>
