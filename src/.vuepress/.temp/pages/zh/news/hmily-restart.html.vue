...
<h2 id="调整-hmily-架构-更合理的模块划分" tabindex="-1"><a class="header-anchor" href="#调整-hmily-架构-更合理的模块划分"><span>调整 Hmily 架构，更合理的模块划分</span></a></h2>
...
<h3 id="梳理-hmily-社区-issue-解决-bug。" tabindex="-1"><a class="header-anchor" href="#梳理-hmily-社区-issue-解决-bug。"><span>梳理 Hmily 社区 issue，解决 bug。</span></a></h3>
...
<h3 id="社区共建" tabindex="-1"><a class="header-anchor" href="#社区共建"><span>社区共建</span></a></h3>
...
<h3 id="最近" tabindex="-1"><a class="header-anchor" href="#最近"><span>最近</span></a></h3>
...
<h3 id="大约在冬季" tabindex="-1"><a class="header-anchor" href="#大约在冬季"><span>大约在冬季</span></a></h3>
<p>很高兴来了这里季节，在这个时间点，会发布<code v-pre>hmily-2.2.0</code>版本，这个版本将完全支持<code v-pre>TAC</code>,<code v-pre>TCC</code>模式。
<code v-pre>TAC(transaction auto rollback)</code> ：有了这个模式，用户再也不用担心像 TCC 那样去写反向的 cancel 方法了。大大减少了使用成本以及学习成本。
<code v-pre>TCC</code>: 稳定性，可靠性得到大大加强，彻底解决事务悬挂问题。</p>
<h3 id="以后的以后" tabindex="-1"><a class="header-anchor" href="#以后的以后"><span>以后的以后</span></a></h3>
<ul>
...
<li>gitee：https://github.com/shuaiqiyu/hmily</li>
