...
<h2 id="hutool-是什么" tabindex="-1"><a class="header-anchor" href="#hutool-是什么"><span>Hutool 是什么</span></a></h2>
<figure><img src="/assets/img/architecture/hutool-framework.png" alt="架构全景图" tabindex="0"><figcaption>架构全景图</figcaption></figure>
...
<h3 id="❌-不兼容特性" tabindex="-1"><a class="header-anchor" href="#❌-不兼容特性"><span>❌ 不兼容特性</span></a></h3>
