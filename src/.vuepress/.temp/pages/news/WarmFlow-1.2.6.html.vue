<template><div><h2 id="" tabindex="-1"><a class="header-anchor" href="#"><span><img src="/assets/img/news/WarmFlow-1.2.6-0.png" alt=""></span></a></h2>
<h2 id="warm-flow-1-2-6-version-update" tabindex="-1"><a class="header-anchor" href="#warm-flow-1-2-6-version-update"><span>warm-flow 1.2.6 Version update</span></a></h2>
<h3 id="this-change" tabindex="-1"><a class="header-anchor" href="#this-change"><span>This change</span></a></h3>
<blockquote>
<p>Process status: can receive external transmission, can support string
add api: add to get next node information
id generation: supports id of other digits and can be serialized for front-end precision problems.</p>
</blockquote>
<ul>
<li>
<p>v1.2.6 2024-08-28</p>
</li>
<li>
<p>[feat] Add api @ xiarigang for obtaining the next node collection</p>
</li>
<li>
<p>[feat] id memory policy adds 14 and 15-bit snowflake algorithm support</p>
</li>
<li>
<p>[feat] process activation and suspension case @ xiaoxiaoliu889</p>
</li>
<li>
<p>[feat] Add @ xiaoxiaoliu889 to get flow chart based on process definition Id</p>
</li>
<li>
<p>[update] Change the process status to string type @ xiarigang</p>
</li>
<li>
<p>[update] Test module split independent warehouse</p>
</li>
<li>
<p>[update] modes-sb delete the loading configuration file and load it with upper-level jar instead</p>
</li>
<li>
<p>[update] yml version of flex solon is wrong, config is adjusted</p>
</li>
<li>
<p>[refactor] Logical refactoring of process version number generation @ xiaoxiaoliu889</p>
</li>
<li>
<p>[fix] Fix that the user data cannot be deleted correctly according to the deleteByTaskIds</p>
</li>
<li>
<p>[fix] fix jpa solon annotation problem @ vanlin</p>
</li>
<li>
<p>[fix] Fix the problem of ending the process incorrectly when the parallel gateway 3 a task branch.</p>
</li>
<li>
<p>Execute the upgrade script [warm-flow_1.2.6. SQL]]</p>
</li>
<li>
<p>Change the flow_status field to string type, and the business system needs to modify it accordingly.</p>
</li>
<li>
<p>[Upgrade Notes]]</p>
</li>
...
<h2 id="warm-flow-introduction" tabindex="-1"><a class="header-anchor" href="#warm-flow-introduction"><span>warm-flow introduction</span></a></h2>
<blockquote>
