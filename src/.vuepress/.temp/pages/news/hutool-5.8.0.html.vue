...
<h2 id="what-is-hutool" tabindex="-1"><a class="header-anchor" href="#what-is-hutool"><span>What is Hutool</span></a></h2>
<p>! [architecture panorama] (/ assets/img/architecture/hutool - framework. PNG)</p>
<p>Originally, this version should have been 5.7.23, but the user raised some issues, which must be resolved by modifying the original code structure:</p>
<ol>
<li>For example, when the MongoDB client is packaged, the packaged tool class has to be modified due to incompatible modifications to its driver.</li>
<li>The part of the code involved in Bean copy (BeanCopier), due to a parameter failure, thought it was just a simple bug, and later found that there was a problem with the whole design... You can imagine the extent of the crash, liver spent two nights refactoring this part of the code.</li>
<li>When I modified the code, I found that there were many design problems in many parts, and I made small refactoring by the way.</li>
<li>In order to solve the possible impact of each major version upgrade on old users, this version is released in a milestone way, the version is M1 (feel to send a CPU to the user), and it is also to solve the problem of each &quot;radical&quot; upgrade of Hutool (after all, old age, to be stable).</li>
<li>Purchase instead of donation, if you want to support Hutool, you can go to the Hutool home page and click -&gt; click into the surrounding stores to buy Hutool peripheral to support Hutool. Oh, this is more affordable than donation (after all, I do not know how to thank the donor, it is a moral burden...)</li>
</ol>
<p>Thank you to the Hutool members who discussed and solved a lot of issues together in this release:
@阿超 @Cherryrum @Husky</p>
<hr>
<h2 id="_5-8-0-m1" tabindex="-1"><a class="header-anchor" href="#_5-8-0-m1"><span>5.8.0.M1</span></a></h2>
<h3 id="❌-incompatible-feature" tabindex="-1"><a class="header-anchor" href="#❌-incompatible-feature"><span>❌ Incompatible feature</span></a></h3>
<p>• 【db 】 【 Not backward compatible 】 Added MongoDB4.x support Return MongoClient change (pr#568@Gitee)
...
• 【json】【Possible compatibility issues】isOrder is discarded in JSONConfig, and is all ordered by default</p>
<h3 id="🐣-new-features" tabindex="-1"><a class="header-anchor" href="#🐣-new-features"><span>🐣 New features</span></a></h3>
<p>• 【http 】 HttpRequest.form is in TableMap mode (issue#I4W427@Gitee)
• 【core 】 AnnotationUtil adds getAnnotationAlias (pr#554@Gitee)
• 【core 】 FileUtil.extName added special handling for tar.gz (issue#I4W5FS@Gitee)<br>
...
• 【core 】 Base32 adds pad support (pr#2195@Github)<br>
...
• 【poi 】 Optimizes ExcelBase and puts alias in<br>
• 【core 】 Improved StrUtil#startWith and endWith performance
• 【cron 】 Add CronPatternParser and MatcherTable<br>
• 【http 】 GlobalHeaders add system attributes allowUnsafeServerCertChange、allowUnsafeRenegotiation<br>
...
• 【poi 】 ExcelWriter adds addImg overload (issue#2218@Github)<br>
• 【bloomFilter】 Added FuncFilter
• 【http 】 Added GlobalInterceptor（issue#2217）</p>
<h3 id="🐞bug-fixed" tabindex="-1"><a class="header-anchor" href="#🐞bug-fixed"><span>🐞Bug fixed</span></a></h3>
<p>• 【core 】 Fix ObjectUtil.hasNull passing null returns true (pr#555@Gitee)
...
• 【http 】 Fix to GET parameter carrying issue (issue#2189@Github)<br>
• 【core 】 Fix the parent path error of FileUtil and FileCopier relative paths (pr#2188@Github)
• 【core 】 Fixed invalid fieldNameEditor in CopyOptions (issue#2202@Github)<br>
• 【json 】 Fix JSON parsing of Map.Entry<br>
...
• 【core 】 Fix lunar calendar to Gregorian calendar in leap month error (issue#I4ZSGJ@Gitee)</p>
<h2 id="community-co-construction" tabindex="-1"><a class="header-anchor" href="#community-co-construction"><span>Community co-construction</span></a></h2>
<p>We uphold the principle of <code v-pre>harmony and happiness</code>, <code v-pre>code first</code>, if you have ideas, are willing to grow with us, contribute together, come and join us!</p>
<ul>
<li>github:https://github.com/dromara/hutool</li>
<li>gitee:https://gitee.com/dromara/hutool</li>
</ul>
</div></template>
