<template><div><h2 id="warm-flow-1-2-4-version-update" tabindex="-1"><a class="header-anchor" href="#warm-flow-1-2-4-version-update"><span>warm-flow 1.2.4 version update</span></a></h2>
<ul>
<li>
<p>Please check the official website update record for main contents, specific details and upgrade precautions.</p>
</li>
<li>
<p>[feat] activate and suspend</p>
</li>
<li>
<p>[feat] Different nodes also support configuring the approval form path</p>
</li>
<li>
<p>[feat] supports receiving external process status and process status extension</p>
</li>
<li>
<p>[feat] Added spel conditional expressions. Added conditional expressions that can be loaded through the SPI mechanism</p>
</li>
<li>
<p>[feat] adds an assignment listener to support dynamic modification of handlers in agent tasks</p>
</li>
<li>
<p>[feat] Added Easy-Query framework support</p>
</li>
<li>
<p>[feat] new Mybatis-Flex solon expansion package</p>
</li>
<li>
<p>[feat] new Jpa solon expansion package</p>
</li>
<li>
<p>[feat] Add a jump type to the history table and record the jump type</p>
</li>
<li>
<p>[feat] add component loading, yml control switch</p>
</li>
</ul>
...
<li>
<ul>
<li>reading difficulty: * * all English notes, for people with poor English, there is indeed a threshold.</li>
</ul>
</li>
</ul>
</li>
...
<blockquote>
<p>Warm-Flow domestic workflow engine🎉, Its characteristics are simple and lightweight but not simple, complete with five internal organs, independent components, expandable, and can meet the components of small and medium-sized projects.</p>
</blockquote>
<ol>
<li>
...
<li>
<p>Conditional expressions: Built-in common conditional expressions, and support for custom extensions.</p>
</li>
<li>
<p>orm framework extension: currently supports MyBatis, Mybatis-Plus, Mybatis-Flex and Jpa, and other support will be provided by the community in the future, which is convenient for expansion.</p>
</li>
<li>
...
<p>Support both Spring and Solon</p>
<ol start="11">
<li>
...
<figure><img src="/assets/img/news/warm-flow-1.2.4-0.png" alt="" tabindex="0"><figcaption></figcaption></figure>
