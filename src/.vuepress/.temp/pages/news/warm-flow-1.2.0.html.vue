<template><div><h2 id="warm-flow1-2-0-major-updates" tabindex="-1"><a class="header-anchor" href="#warm-flow1-2-0-major-updates"><span>warm-flow1.2.0 major updates</span></a></h2>
<figure><img src="/assets/img/news/warm-flow-1.2.0-0.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p>This version has been greatly changed, bringing the long-awaited countersign, ticket signing, transfer, oracle and pg database adaptation, etc., and making corresponding code refactoring. Also due to the large changes, if problems are found, issue can be submitted in time. If it can help solve bug and pr, thank you very much. The continuous improvement of warm-flow cannot be separated from everyone. (Thanks to warm organization members, Tirion Fordring | Liang Trabecular | Vanlin | Zhen, and those who participated in pr)</p>
<ul>
<li>
<p>v1.2.0 2024-06-13 Precautions: Toolkit Path Adjustment, New Upgrade Script</p>
</li>
<li>
<p>Decompose users on behalf of the table and add a user table (the query method needs to be changed)</p>
</li>
<li>
<p>CC</p>
</li>
<li>
<p>countersignature, ticket signature</p>
</li>
<li>
<p>Add and subtract</p>
</li>
<li>
<p>Retransfer and improvement</p>
</li>
<li>
<p>jpa extension</p>
</li>
<li>
<p>Oracle Adaptation</p>
</li>
<li>
<p>pg adaptation</p>
</li>
</ul>
<h2 id="historical-background" tabindex="-1"><a class="header-anchor" href="#historical-background"><span>Historical background</span></a></h2>
...
<h2 id="what-warm-flow-can-bring-you" tabindex="-1"><a class="header-anchor" href="#what-warm-flow-can-bring-you"><span>What warm-flow can bring you</span></a></h2>
<blockquote>
<p>[!IMPORTANT]🎉Domestic self-developed workflow engine, its characteristics are simple (only 7 tables) but not simple, complete, independent components, scalable, can meet the components of small and medium-sized projects.</p>
</blockquote>
<ol>
<li>
<p>Support regular process flow, such as through, back, termination and arbitrary jump</p>
</li>
<li>
<p>Support transfer, assignment, addition and subtraction, and the task will eventually return to the initiator.</p>
</li>
<li>
<p>Support or sign, countersign and ticket sign</p>
</li>
<li>
<p>Business projects can not rely on process designers, components will generate process pictures.</p>
</li>
<li>
...
<li>
<p>Support the use of different orm framework systems, support different orm frameworks and database extensions.</p>
</li>
</ol>
