...
<template>
  <div class="home-page">
      ...
      <div class="wrapper">
        <div class="banner-mask">
          <div class="banner-info">
            ...
            <p class="banner-description">{{ homeLocale.DESCRIPTION }}</p>
      ...
      <div class="star-container">
        <div class="star-wrapper">
          <div class="star-inner">
            <div class="star-text">{{ homeLocale.STARS_OVERALL }}</div>
            <div class="star-block">
              <div class="star-number">{{ currentStars }}k</div>
            </div>
          </div>
          <cite> {{ homeLocale.DATA_SOURCE }} </cite>
        </div>
      </div>
    </div>
    ...
    <div class="project-container">
      <h2 class="header-project">{{ homeLocale.PROJECT }}</h2>
      <RouterLink to="./projects/" class="more">{{
      ...
      <div class="project-swiper">
        ...
        >
          <swiper-slide
            v-for="item in homeLocale.PROJECT_DETAILS"
            :key="item.name"
          >
          ...
          >
            ...
            >
              ...
              <template v-for="item in section.details" :key="item.title">
                <div class="community-item" @click="$router.push(item.url)">
                  <div class="content">
